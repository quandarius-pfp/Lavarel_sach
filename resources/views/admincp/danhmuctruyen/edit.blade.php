                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('danhmuc.update',[$danhmuc->id])}}">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="slug" aria-describedby="emailHelp" onkeyup="ChangeToSlug();"placeholder="Nhập tên danh mục . . . " name="tendanhmuc" value="{{$danhmuc->tendanhmuc}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Slug Danh Mục</label>
                            <input type="text" class="form-control" id="convert_slug" aria-describedby="emailHelp" placeholder="Nhập  Slug . . . " name="slug_danhmuc" value="{{$danhmuc->slug_danhmuc}}">
                          </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Mô tả danh mục</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả danh mục . . ." name="mota" value="{{$danhmuc->mota}}">
                          </div>
                          <div class="mb-3">
